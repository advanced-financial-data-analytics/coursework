...
This module assessment helps you understand and apply different ways to analyze financial data that changes over time (like stock prices or exchange rates). You'll start with simple techniques to explore and visualize the data, then move on to more advanced methods to build models and make forecasts. Even if you're not a math whiz, this module focuses on helping you understand what the results mean and how they can be used in finance.
...
### Written Report (70% of total mark)

You need to submit a professional research report (maximum 3000 words) with these sections:

1.  **Introduction (10 marks):**
    -   Give background information on the topic.
    -   Clearly state what you want to achieve with your research.
    -   Summarize previous research on the topic.
    -   Briefly describe the methods you'll use.

2.  **Data and Methods (20 marks):**
    -   Describe the data you'll use in detail.
    -   Explain any steps you take to clean or prepare the data.
    -   Justify why you chose the methods you used.
    -   Describe how you implemented the methods.

3.  **Results (25 marks):**
    -   Present your results clearly using tables and figures.
    -   Explain what the statistical results mean in simple terms.
    -   Check if the models meet the necessary assumptions.
    -   Compare the performance of different models or methods.

4.  **Discussion (15 marks):**
    -   Summarize the key findings of your analysis.
    -   Discuss any limitations of your data or methods.
    -   Explain how your findings can be used in real-world situations.
